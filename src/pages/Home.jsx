    ...
    <>
      ...
      >
        <img
          src={grabpanda}
          alt="GrabPanda"
          className="object-contain block sm:hidden w-1/2 h-1/2 bg-transparent"
        />
        <TextType
          text={[
      ...
      <div className="flex flex-col lg:flex-row gap-4 w-full justify-evenly items-center lg:items-start h-100">
        <ScrollAnimation
          ...
          once={false}
          duration={2}
          className="p-8 pb-0 lg:pb-8 lg:w-1/2 place-content-center h-full"
          delay={0.8}
        >
          <h1 className="text-4xl font-bold font-pacifico text-green-400">
            Dine with us
          </h1>
          <p className="text-lg font-pacifico text-gray-400">
            Experience the best dining experience with us
          </p>
          <p className="font-merriweather text-gray-700">
            Enjoy the fresh air and ambiance of our outdoor area or enjoy a
            comfortable and climate-controlled dining experience within our
            indoor area, paired with impeccable service that ensures every
            moment of your visit is perfect.
          </p>
        </ScrollAnimation>
        <ScrollAnimation
          animation="slideLeft"
          once={false}
          duration={2}
          className="p-8 pt-0 lg:pt-8 lg:w-1/2"
          delay={0.8}
        >
          <img
